...
// 启用全局方法权限控制，并且设置prePostEnabled = true，保证@PreAuthorize、@PostAuthorize、@PreFilter、@PostFilter生效
...
public class WebAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    */
    ...
    protected void configure(AuthenticationManagerBuilder builder) throws Exception {
        ...
        // 临时使用内存版登录的模式测试代码
        // builder.inMemoryAuthentication().passwordEncoder(new BCryptPasswordEncoder()).withUser("yangmi").password(new BCryptPasswordEncoder().encode("123123")).roles("ADMIN");
    ...
    protected void configure(HttpSecurity security) throws Exception {
        ...
        security
                ...
                .logoutSuccessUrl("/admin/to/login/page.html") // 指定退出成功之后前往的地址
                ;
